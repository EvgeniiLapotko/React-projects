            ...
            try {
                ...
                if(data.drinks){
                    const {strDrink:name, strDrinkThumb:image, strAlcoholic:info, strCategory:category, strGlass:glass, strInstructions: instructions, strIngredient1,
                        strIngredient2, strIngredient3, strIngredient4, strIngredient5 } = data.drinks[0];
        ...
        <section className="single">
            ...
            <div className="single__inner">
                ...
                <div className="single__item">
                    ...
                    <p className="single__item-text">
                        <span className='single__item-span'>category :</span>
                        {category}
                    </p>
                    <p className="single__item-text">
                    ...
                    <p className="single__item-text">
                        <span className='single__item-span'>instructions :</span>
                        {instructions}
                    </p>
                    <p className="single__item-text">
                        <span className='single__item-span'>ingredients :</span>
                        {ingredients.map((item, index) => {
                            return <span key={index} className='single__item-ingr'>
                                {item? `${item}, `: null}
                            </span>
                        })}
