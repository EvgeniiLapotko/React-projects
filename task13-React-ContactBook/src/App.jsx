    ...
    return (
        <div className="app">
            <div className="container">
                <Header login={login} exit={logOut} getName={getName} name={userName}/>
                <h1 className="title">
                    PhoneBook
                </h1>
                <form className="form" onSubmit={handleSubmit}>
                    <label className='label' htmlFor="name">Name</label>
                    <input className='input__add' id='name' type="text" placeholder='Enter Name' ref={inputName} />
                    <label className='label' htmlFor="number">Number</label>
                    <input className='input__add' id='number' type="text" placeholder='Enter number' ref={inputNum} />
